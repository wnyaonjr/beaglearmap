...
/**
 * The class that takes care of the transformation
 */
public class Camera {
	public static float DEFAULT_VIEW_ANGLE = (float) Math.toRadians(90);
	...
	/** Sets the view angle given the height and width **/

...
public class Matrix {
	...
	/** Sets the value of the matrix equal to the value of Matrix m **/
	...
	/** Transforms the matrix to its identity matrix **/
	public void toIdentity() {
		set(1, 0, 0, 0, 1, 0, 0, 0, 1);
	}

	/** Performs X Rotation based on the given angleX **/
	...
	/** Performs Y Rotation based on the given angleY **/
	...
	/** Performs Z Rotation based on the given angleZ **/
	...
	/** Transforms the matrix to its inverse **/
	public void invert() {
		float det = this.det();
	...
	/** Performs transpose operation to the matrix **/
	...
	/** Multiplies c to every matrix element **/
	...
	/** Adds up Matrix n to the matrix **/
	...
	/** Multiplies Matrix n to the matrix **/
